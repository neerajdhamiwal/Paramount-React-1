        ...
        return(
                <div>{this.state.loading ?
                    <center >
                        ...
                        {this.state.teamData.hasOwnProperty('award_slider_id')?this.state.teamData['award_slider_id'][0][0].award_slider_id? <AwardSlider clientData = {this.state.teamData['award_slider_id'][0]}/>: '':''}
                        {this.state.teamData.hasOwnProperty('certificate_slider_id')? this.state.teamData['award_slider_id'][0][0].certificate_slider_id ? <CertSlider clientData = {this.state.teamData['certificate_slider_id'][0]}/>: '':''}
                    </div>}
          </div>
        )
    }
