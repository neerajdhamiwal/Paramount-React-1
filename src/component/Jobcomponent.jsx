                ...
                {this.props.careerData.hasOwnProperty('nid')?
                    this.props.careerData['nid'][0].map((obj, i)=>{
                        return <li key={i} className="accordion-item" data-accordion-item="" >
                            ...
                            }<a className="accordion-title" aria-controls={`tab${i}`} role="tab" id={`job${obj.nid}`} aria-expanded="false" aria-selected="false">
                            ...
                            <div className="accordion-content" data-tab-content="" role="tabpanel" aria-labelledby={`job${obj.nid}`} aria-hidden="true" id={`tab${i}`}>
                                <div className="grid-x align-justify">
                                    <div className="cell small-12 medium-8" id="coltab">
                                        <div className="job-deties-req">
                                            {//eslint-disable-next-line
                                            }<a> <div className={this.props.duty?'activeTab job-duties':'job-duties'} onClick={this.props.handleChange}>Duties</div></a>
                                            {//eslint-disable-next-line
                                            }<a> <div className={!(this.props.duty)?'activeTab job-req':'job-req'} role="tab"  onClick={this.props.handleChange}>Requirement</div></a>
                                        </div>
                                        {this.props.duty?<p>
