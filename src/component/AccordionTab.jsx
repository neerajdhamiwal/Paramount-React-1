                                        ...
                                        return <div className={index === 0 ? "page" : "page hide"}
                                            ...
                                            <div className="grid-x grid-padding-x tab-accordion-content">
                                                <div className="medium-5 cell">
                                                    ...
                                                    {service.image_slider_cta_button_title !==''? <a href={service.image_slider_cta_button_url.substring(9)} className="button white-btn">{ReactHtmlParser(service.image_slider_cta_button_title)}</a>:''}
                                                </div>
                                                </div>
