            ...
            <section className="left-image-right-content">
                {this.props.secondary? <div className="grid-container custom-grid custom-grid-left">
                        <div className="grid-x align-middle">
                            <div className="small-12 medium-6 cell no-padding wow slideInLeft p-right-45">
                                <div className="img-relative-title-ru">
                                    ...
                                    <div className="left-image-block"><img src={apiUrl+this.props.data.secondary_image_description_img} alt=""/></div>
                                </div>
                            </div>
